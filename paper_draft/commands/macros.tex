...
\newcommand{\pqk}{\textsc{Projected-QK}\xspace}
\newcommand{\fqk}{\textsc{Fidelity-QK}\xspace}
\newcommand{\isk}{\textsc{Interval-QK}\xspace}

% Diagnostic
\newcommand{\gdiff}{\ensuremath{g}\xspace}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DATASET NAMES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Task / dataset names (use \textsc for consistency)
\newcommand{\engtask}{\textsc{Engineered}\xspace}
\newcommand{\dlogtask}{\textsc{Discrete-Log}\xspace}
...
\newcommand{\dlp}{\textsc{DLP}\xspace}
\newcommand{\qml}{QML\xspace}
